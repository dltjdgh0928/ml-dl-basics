...
start  = time.time()
print('시작')
x_augmented = train_datagen.flow(x_augmented, y_augmented, batch_size=augment_size, shuffle=False, save_to_dir='d:/temp/').next()[0]
print('끝')
end = time.time()
print(end-start)

print(augment_size, "개 증폭에 걸린시간 : ", round(end-start, 2), '초')
