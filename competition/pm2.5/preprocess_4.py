...
def get_monthly_features(month: int):
    """주어진 달(momth)에 대한 사인과 코사인 함수 값을 반환"""
    radians_per_month = 2 * np.pi * month / 12.0
    return [np.sin(radians_per_month), np.cos(radians_per_month)]
