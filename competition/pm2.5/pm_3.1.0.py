...
submission = pd.read_csv('./_data/_ai_spark/answer_sample.csv', index_col=0)
...
submission['PM2.5']=l
submission.to_csv('./_save/finedust/_Submit_time1031.csv')
...
# model1.save("./_save/finedust/Aiur_Submit1.h5")
# model2.save("./_save/finedust/Aiur_Submit2.h5")
# model3.save("./_save/finedust/Aiur_Submit3.h5")
# model4.save("./_save/finedust/Aiur_Submit4.h5")
# model5.save("./_save/finedust/Aiur_Submit5.h5")
# model6.save("./_save/finedust/Aiur_Submit6.h5")
# model7.save("./_save/finedust/Aiur_Submit7.h5")
# model8.save("./_save/finedust/Aiur_Submit8.h5")
# model9.save("./_save/finedust/Aiur_Submit9.h5")
# model10.save("./_save/finedust/Aiur_Submit10.h5")
# model11.save("./_save/finedust/Aiur_Submit11.h5")
# model12.save("./_save/finedust/Aiur_Submit12.h5")
# model13.save("./_save/finedust/Aiur_Submit13.h5")
# model14.save("./_save/finedust/Aiur_Submit14.h5")
# model15.save("./_save/finedust/Aiur_Submit15.h5")
# model16.save("./_save/finedust/Aiur_Submit16.h5")
# model17.save("./_save/finedust/Aiur_Submit17.h5")
# model18.save("./_save/finedust/Aiur_Submit18.h5")
# model19.save("./_save/finedust/Aiur_Submit19.h5")
# model20.save("./_save/finedust/Aiur_Submit20.h5")
# model21.save("./_save/finedust/Aiur_Submit21.h5")
# model22.save("./_save/finedust/Aiur_Submit22.h5")
# model23.save("./_save/finedust/Aiur_Submit23.h5")
# model24.save("./_save/finedust/Aiur_Submit24.h5")
# model25.save("./_save/finedust/Aiur_Submit25.h5")
# model26.save("./_save/finedust/Aiur_Submit26.h5")
# model27.save("./_save/finedust/Aiur_Submit27.h5")
# model28.save("./_save/finedust/Aiur_Submit28.h5")
# model29.save("./_save/finedust/Aiur_Submit29.h5")
# model30.save("./_save/finedust/Aiur_Submit30.h5")
# model31.save("./_save/finedust/Aiur_Submit31.h5")
# model32.save("./_save/finedust/Aiur_Submit32.h5")
# model33.save("./_save/finedust/Aiur_Submit33.h5")
# model34.save("./_save/finedust/Aiur_Submit34.h5")
# model35.save("./_save/finedust/Aiur_Submit35.h5")
# model36.save("./_save/finedust/Aiur_Submit36.h5")
# model37.save("./_save/finedust/Aiur_Submit37.h5")
# model38.save("./_save/finedust/Aiur_Submit38.h5")
# model39.save("./_save/finedust/Aiur_Submit39.h5")
# model40.save("./_save/finedust/Aiur_Submit40.h5")
# model41.save("./_save/finedust/Aiur_Submit41.h5")
# model42.save("./_save/finedust/Aiur_Submit42.h5")
# model43.save("./_save/finedust/Aiur_Submit43.h5")
# model44.save("./_save/finedust/Aiur_Submit44.h5")
# model45.save("./_save/finedust/Aiur_Submit45.h5")
# model46.save("./_save/finedust/Aiur_Submit46.h5")
# model47.save("./_save/finedust/Aiur_Submit47.h5")
# model48.save("./_save/finedust/Aiur_Submit48.h5")
# model49.save("./_save/finedust/Aiur_Submit49.h5")
# model50.save("./_save/finedust/Aiur_Submit50.h5")
# model51.save("./_save/finedust/Aiur_Submit51.h5")
# model52.save("./_save/finedust/Aiur_Submit52.h5")
# model53.save("./_save/finedust/Aiur_Submit53.h5")
# model54.save("./_save/finedust/Aiur_Submit54.h5")
# model55.save("./_save/finedust/Aiur_Submit55.h5")
# model56.save("./_save/finedust/Aiur_Submit56.h5")
# model57.save("./_save/finedust/Aiur_Submit57.h5")
# model58.save("./_save/finedust/Aiur_Submit58.h5")
# model59.save("./_save/finedust/Aiur_Submit59.h5")
# model60.save("./_save/finedust/Aiur_Submit60.h5")
# model61.save("./_save/finedust/Aiur_Submit61.h5")
# model62.save("./_save/finedust/Aiur_Submit62.h5")
# model63.save("./_save/finedust/Aiur_Submit63.h5")
# model64.save("./_save/finedust/Aiur_Submit64.h5")
# model65.save("./_save/finedust/Aiur_Submit65.h5")
# model66.save("./_save/finedust/Aiur_Submit66.h5")
# model67.save("./_save/finedust/Aiur_Submit67.h5")
# model68.save("./_save/finedust/Aiur_Submit68.h5")
# model69.save("./_save/finedust/Aiur_Submit69.h5")
# model70.save("./_save/finedust/Aiur_Submit70.h5")
# model71.save("./_save/finedust/Aiur_Submit71.h5")
# model72.save("./_save/finedust/Aiur_Submit72.h5")
