...
for i in range(72):
    ...
    model:Sequential=globals()[f'model{i+1}']
    ...
    layer2=LSTM(36)(input1)
    layer2=Dense(12, activation='relu')(layer2)
    layer2=Dense(9, activation='relu')(layer2)
    layer2=Dense(1)(layer2)

    layer3=LSTM(28)(input1)
    layer3=Dense(20, activation='relu')(layer3)
    layer3=Dense(7, activation='relu')(layer3)
    layer3=Dense(1)(layer3)
    
    layer4=concatenate([layer1,layer2,layer3])
    output=Dense(1,use_bias=False)(layer4)
...
submission['PM2.5']=l
submission.to_csv('./_save/finedust/_Submit_time1423.csv')
