...
from preprocess_210 import bring
...
from preprocess_210 import get_hourly_features
...
from preprocess_210 import load_aws_and_pm
...
from preprocess_210 import distance
...
from preprocess_210 import scaled_score
...
from preprocess_210 import split_x
for i in range(72):
...
# 4.1 Model
input1 = Input(shape=(timesteps, x1_train.shape[2]))
...
for i in range(72):
    globals()['model{}'.format(i+1)] = Model(inputs=input1, outputs=output1)
...
for i in range(72):
    ...
    globals()['model{}'.format(i+1)].fit(globals()['x{}_train'.format(i+1)], globals()['y{}_train'.format(i+1)], batch_size=1024, epochs=3,
          callbacks=[es,rl],
