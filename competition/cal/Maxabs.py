...
for i in range(10000):
    kf = KFold(n_splits=50, shuffle=True, random_state=i+123)
    ...
    for train_idx, test_idx in kf.split(x):
        ...
        def objective(trial):
            alpha = trial.suggest_loguniform('alpha', 10e-08, 10e-06)
            n_restarts_optimizer  = trial.suggest_int('n_restarts_optimizer', 3, 20)
